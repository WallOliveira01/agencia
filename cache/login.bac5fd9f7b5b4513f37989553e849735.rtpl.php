...
<head>
  ...
  <title>Connect Films | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="/admin/login"><b>Connect</b> Films</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      <p class="login-box-msg">Faça login para inciar a sessão</p>

      <form action="/admin/login" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Login" name="login" id="txtLogin" required>
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" id="btnEnviar" class="btn btn-danger btn-block btn-flat">Entrar</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
...
<script src="../../res/admin/dist/js/script.js"></script>
