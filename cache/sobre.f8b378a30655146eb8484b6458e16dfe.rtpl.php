    ...
    <div class="section about" id="section-about">
        ...
        <div class="container-fluid">
             <div class="row">
                ...
                <div class="col-6  fulltext">
                    <div class="info">
                        <div class="voffset-170"></div>
                         <h3 class="about__title">Tem um projeto em mente?<br>Você pode nos contatar por email!</h3>
                          <p>Baseado em Londres. Nós empurramos limites pensando que não
apenas sobre sua marca, seu site ou seu marketing digital
mas como todos os elementos digitais da sua empresa funcionam juntos.</p>

<p>Através de nossas melhores técnicas da classe e sob medida 
